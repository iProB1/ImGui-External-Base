...
bool ImGui::ButtonExx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    window->DrawList->AddRectFilled(rect.Min, rect.Max, ImColor(77, 77, 77, (int)it_anim->second.active_rect_alpha), 3.f);

    window->DrawList->AddRect(rect.Min, rect.Max, ImColor(255, 255, 255, (15 + (int)it_anim->second.active_outline_anim)), 3.f);

    PushStyleColor(ImGuiCol_Text, ImVec4(ImColor(255, 255, 255, 100 + (int)it_anim->second.active_rect_alpha)));
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (!is_multiline)
    {
        ...
        draw_window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, ImColor(240, 240, 240, (int)it_anim->second.active_rect_alpha),5);
